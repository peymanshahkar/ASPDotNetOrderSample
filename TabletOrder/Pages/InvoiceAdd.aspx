<%@ Page Title="سفارش جدید" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="InvoiceAdd.aspx.cs" Inherits="TabletOrder.Pages.InvoiceAdd" %>
                        ...
                        <div class="row input-panel">
                            ...
                            <div class="col-md-6">
                                <div class="form-group row">
                                    ...
                                    <div class="col-md-8">
                                        <asp:TextBox ID="searchInput" CssClass="form-control" runat="server" OnTextChanged="searchInput_TextChanged" AutoPostBack="true" />
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6">
